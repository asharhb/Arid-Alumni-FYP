        ...
        <div id="page-content-wrapper">
            ...
            <section>
                <div class="container-fluid px-4">
                    <div class="row my-5">
                        <h3 class="admin">Testimonial</h3><br><br><br><br>
                        <div class="col">
               ...
               while($a = mysqli_fetch_array($res))
              {
               ...
               ?>
                                    <tr>
                                        ...
                                        <td><?php echo $a['post'] ?></td>
                                        <td><a href="../<?php echo $a['img'] ?>"><img src="../<?php echo $a['img'] ?>" class="img_cnic" alt="id"></a></td>
                                        <td><?php echo $a['msg'] ?></td>
                                        <?php 
                                        if ($a['status']==1) {  ?>
                                            <td><a href="custom.php?id=<?php echo $a['id'] ?>&type=fb&status=0&daily=fbapprove"> Approve </a> / <a href="custom.php?id=<?php echo $a['id'] ?>&type=fb&status=2&daily=fbdeny"> Deny </a></td>
